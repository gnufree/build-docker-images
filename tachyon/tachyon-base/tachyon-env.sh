...
if [[ `uname -a` == Darwin* ]]; then
  ...
  export TACHYON_RAM_FOLDER=/data/tachyon/ramdisk
fi
...
export TACHYON_MASTER_ADDRESS=tachyon-master
#export TACHYON_UNDERFS_ADDRESS=$TACHYON_HOME/underFSStorage
export TACHYON_UNDERFS_ADDRESS=hdfs://hadoop-master.kmsocial.cn:9000
